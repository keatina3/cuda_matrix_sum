...
void write_times(char* funcname, double tauCPU, double tauGPU, double tauGPUohead, int block, int n, int m, double err);
...
void write_times(char* fname, double tauCPU, double tauGPU, double tauGPUohead, int block, int n, int m, double err){
	FILE* fptr;
